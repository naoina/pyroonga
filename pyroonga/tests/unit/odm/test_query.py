...
class TestSelectQuery(object):
    ...
    @pytest.mark.parametrize(('columns', 'expected'), (
        ...
        ((make_match_column('c1', 'T1'), make_match_column('c2', 'T2')), r'T1.c1 || T2.c2'),
        ((make_match_column('c1'), make_match_column('c2'), make_match_column('c3')),
            r'T.c1 || T.c2 || T.c3'),
        ((make_match_column('c1', 'T1'), make_match_column('c2', 'T2'),
          make_match_column('c3', 'T3')), r'T1.c1 || T2.c2 || T3.c3'),
